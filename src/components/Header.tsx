...
export function Header() {
  return (
    <header className="fixed top-0 left-0 md:left-80 right-0 px-8 py-3 border-b border-white/10 backdrop-blur flex items-center justify-between">
      ...
      <div className="flex items-center">
        <nav className="text-sm hidden flex items-center gap-6 md:flex">
          <a
